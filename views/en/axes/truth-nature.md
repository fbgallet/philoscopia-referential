[Version française](../../fr/axes/truth-nature.md)
...
Is something true because it corresponds to reality, because it fits with everything else we hold, or because it works? Depending on the answer, a belief can be useful yet false, or coherent yet wide of the real. To take a position is to say what exactly we are demanding when we ask "is it true?"

## Poles

### Correspondence

A statement is true if it corresponds to the facts: to speak truly is to say of what is that it is. Truth is a relation between our statements and reality, independent of what we believe.

*[Aristotle](../philosophers/aristotle.md) · [Russell](../philosophers/russell.md)*

### Coherence

A statement is true if it fits without contradiction into an overall system: the true is the whole. No isolated statement is true by itself; its place within the totality is what justifies it.

*[Hegel](../philosophers/hegel.md)*

### Pragmatism

The true is what works: an idea is true if it effectively guides action and withstands the test of inquiry. Truth is not a fixed property but what rigorous investigation converges toward.

*[Peirce](../philosophers/peirce.md) · [James](../philosophers/william-james.md)*

## Grounding relations

- *[Nature of truth](../axes/truth-nature.md) : Coherence* grounds *[Justification of belief](../axes/epistemic-justification.md) : Coherentism* : If a statement is true only by its non-contradictory place within an overall system, then a belief is justified only by its coherence with the entire web of the others. The coherence conception of truth supports coherentism: there is no ultimate foundation, but beliefs that support one another, from the Hegelian whole ([Hegel](../philosophers/hegel.md)) to Quine's "web".
- *[Nature of truth](../axes/truth-nature.md) : Correspondence* grounds *[Nature of art](../axes/art-nature.md) : Mimesis* : If to speak the truth is to accord with an independent reality, then art too can aim to represent the world and human actions faithfully. The correspondence conception of truth supports mimesis: for [Aristotle](../philosophers/aristotle.md), art imitates nature, and its value lies in the accuracy and depth of that imitation.
