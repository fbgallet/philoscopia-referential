...
- *[Source de la connaissance](../axes/knowledge-source.md) : Empirisme* fonde *[Méthode scientifique](../axes/scientific-method.md) : Inductivisme* : Si toute connaissance vient de l'expérience, la science doit partir des faits et remonter, par l'observation de régularités répétées, à des lois générales. L'empirisme fonde l'inductivisme : de Bacon à [Mill](../philosophers/mill.md), c'est l'accumulation méthodique d'observations qui établit notre savoir de la nature.
