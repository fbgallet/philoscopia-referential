[English version](../../en/axes/rights-nature.md)

# Nature des droits

**D'où viennent les droits ?**

*Autrui · descriptif (théorie) · catégoriel*
...
- Le fondement varie : droit naturel et loi divine (Locke), ou dignité et autonomie rationnelle de la personne (Kant).

*[Locke](../philosophers/locke.md)*

### Positivisme juridique

Il n'y a de droits que ceux qu'une autorité établit effectivement. Parler de droits naturels avant toute loi, c'est, selon le mot de Bentham, « un non-sens sur échasses » : un droit sans institution pour le garantir n'est qu'un vœu.

- Le rejet des droits naturels par Bentham tient aussi à son utilitarisme, ce qui le rapproche du pôle voisin.
- Hart, positiviste sur la validité du droit, a pourtant défendu un droit naturel à une liberté égale.
...
- *[Origine du lien social](../axes/social-contract.md) : Contractualisme* fonde *[Nature des droits](../axes/rights-nature.md) : Constructivisme politique* : Si l'ordre légitime naît d'un accord entre personnes libres et égales, les droits eux-mêmes apparaissent comme les termes d'une coopération équitable à construire, et non comme des donnés. Le contractualisme fonde le constructivisme politique : [Rawls](../philosophers/rawls.md) dérive les principes de justice d'un choix rationnel passé derrière un « voile d'ignorance ».
